...
if(isset($_POST['add']))
{
	...
	$sql = "UPDATE vehicles SET status = '{$status}' WHERE vid = {$rid}";
	
	$result=mysqli_query($con,$sql);
	if($result == true)
	{
		$msg="<p class='alert alert-success'>Vehicle Status Updated</p>";
		header("Location:viewvehicle.php?msg=$msg");
	}
	else{
		$msg="<p class='alert alert-warning'>Vehicle Status Not Updated</p>";
		header("Location:viewvehicle.php?msg=$msg");
	}
}
?>
                                            ...
                                            <div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<small>Enter [1] to unavailable & [0] to make it available.</small>
													</div>
												</div>
